...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$CODE_DIRECTORY/GAMs/MathGAM/${TARGET}/
...
#cgdb -ex 'set scheduler-locking step; break MathGAM::Execute' --args $CODE_DIRECTORY/MARTe/${TARGET}/MARTe.ex $1 
